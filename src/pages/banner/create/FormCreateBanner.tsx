...
import { Button, Col, Form, Row, Space, Upload, UploadFile } from 'antd';
...
import { CreateBannerModels } from '@/model/banner.model';
...
const FormCreateBanner = () => {
  ...
  const initialValues: CreateBannerModels = {
    title: '',
    link: '',
    content: '',
    image: '',
  ...
  const buildBody = (values: CreateBannerModels) => {
    const newValues = {
      title: values?.title,
  ...
  const onFinish = (values: CreateBannerModels) => {
